...
func (m *CreateReviewRequest) validate(all bool) error {
	...
	if _, ok := _CreateReviewRequest_ExpressionScore_InLookup[m.GetExpressionScore()]; !ok {
		err := CreateReviewRequestValidationError{
...
var _CreateReviewRequest_ExpressionScore_InLookup = map[int32]struct{}{
	1: {},
	2: {},
	3: {},
	4: {},
